...
for event in bot.longpoll.listen():
    if event.type == VkEventType.MESSAGE_NEW and event.to_me:
        ...
        if request == 'поиск' or request == 'f':
            ...
            bot.sending_messages(user_id, f' База данных отчищена! Сейчас наберите "Поиск" или F ')
            ...
            bot.sending_messages(user_id, f'{bot.title(user_id)} Бот готов к поиску, наберите: \n '
