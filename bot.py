...
class Bot:
    ...
    def title(self, user_id):
        """getting the title of the user who written to the bot"""
    ...
    def input_looking_age(self, user_id, age):
        ...
        try:
            ...
            self.sending_messages(user_id, f' TitleError! Введен не правильный числовой формат! Game over!')
            return
        except ValueError:
            self.sending_messages(user_id, f' ValueError! VВведен не правильный числовой формат! Game over!')
            return
    ...
    def show_found_person(self, user_id):
        ...
        if self.get_found_person_id() == None:
            ...
            self.sending_messages(user_id, self.found_person_info(self.get_found_person_id()))
